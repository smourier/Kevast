...
namespace Kevast
{
    ...
    /// <remarks>
    /// All public and protected members of <see cref="KevastDictionary{TKey,TValue}"/> are thread-safe and may be used
    /// concurrently from multiple threads.
    /// </remarks>
    [DebuggerTypeProxy(typeof(IDictionaryDebugView<,>))]
    [DebuggerDisplay("Count = {Count}")]
    public partial class KevastDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue> where TKey : notnull
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KevastDictionary{TKey,TValue}"/>
        /// class that is empty, has the default concurrency level, has the default initial capacity, and
        /// uses the default comparer for the key type.
        /// </summary>
        public KevastDictionary() : this(DefaultConcurrencyLevel, DefaultCapacity, growLockArray: true, null) { }
        ...
        /// <see cref="KevastDictionary{TKey,TValue}"/> concurrently.</param>
        /// <param name="capacity">The initial number of elements that the <see cref="KevastDictionary{TKey,TValue}"/> can contain.</param>
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="concurrencyLevel"/> is less than 1.</exception>
        /// <exception cref="ArgumentOutOfRangeException"> <paramref name="capacity"/> is less than 0.</exception>
        public KevastDictionary(int concurrencyLevel, int capacity) : this(concurrencyLevel, capacity, growLockArray: false, null) { }
        ...
        /// cref="IEnumerable{T}"/> whose elements are copied to the new <see cref="KevastDictionary{TKey,TValue}"/>.</param>
        ...
        public KevastDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection) : this(collection, null) { }
        ...
        public KevastDictionary(IEqualityComparer<TKey>? comparer) : this(DefaultConcurrencyLevel, DefaultCapacity, growLockArray: true, comparer) { }
        ...
        /// </summary>
        /// <param name="collection">The <see cref="IEnumerable{T}"/> whose elements are copied to the new <see cref="KevastDictionary{TKey,TValue}"/>.</param>
        /// <param name="comparer">The <see cref="IEqualityComparer{TKey}"/> implementation to use when comparing keys.</param>
        /// <exception cref="ArgumentNullException"><paramref name="collection"/> is a null reference (Nothing in Visual Basic).</exception>
        public KevastDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection, IEqualityComparer<TKey>? comparer)
            : this(comparer)
        {
        ...
        /// The estimated number of threads that will update the <see cref="KevastDictionary{TKey,TValue}"/> concurrently.
        /// </param>
        /// <param name="collection">The <see cref="IEnumerable{T}"/> whose elements are copied to the new
        /// <see cref="KevastDictionary{TKey,TValue}"/>.</param>
        /// <param name="comparer">The <see cref="IEqualityComparer{TKey}"/> implementation to use when comparing keys.</param>
        /// <exception cref="ArgumentNullException"><paramref name="collection"/> is a null reference (Nothing in Visual Basic).</exception>
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="concurrencyLevel"/> is less than 1.</exception>
        /// <exception cref="ArgumentException"><paramref name="collection"/> contains one or more duplicate keys.</exception>
        public KevastDictionary(int concurrencyLevel, IEnumerable<KeyValuePair<TKey, TValue>> collection, IEqualityComparer<TKey>? comparer)
        ...
        /// </summary>
        /// <param name="concurrencyLevel">The estimated number of threads that will update the <see cref="KevastDictionary{TKey,TValue}"/> concurrently.</param>
        /// <param name="capacity">The initial number of elements that the <see cref="KevastDictionary{TKey,TValue}"/> can contain.</param>
        /// <param name="comparer">The <see cref="IEqualityComparer{TKey}"/> implementation to use when comparing keys.</param>
        ...
        public KevastDictionary(int concurrencyLevel, int capacity, IEqualityComparer<TKey>? comparer)
            : this(concurrencyLevel, capacity, growLockArray: false, comparer)
        {
        }

        internal KevastDictionary(int concurrencyLevel, int capacity, bool growLockArray, IEqualityComparer<TKey>? comparer)
        {
        ...
        /// <summary>
        /// Attempts to add the specified key and value to the <see cref="KevastDictionary{TKey, TValue}"/>.
        /// </summary>
        /// <param name="key">The key of the element to add.</param>
        /// <param name="value">The value of the element to add. The value can be a null reference (Nothing
        /// in Visual Basic) for reference types.</param>
        /// <returns>
        /// true if the key/value pair was added to the <see cref="KevastDictionary{TKey, TValue}"/> successfully; otherwise, false.
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="key"/> is null reference (Nothing in Visual Basic).</exception>
        /// <exception cref="OverflowException">The <see cref="KevastDictionary{TKey, TValue}"/> contains too many elements.</exception>
        ...
        /// <summary>
        /// Determines whether the <see cref="KevastDictionary{TKey, TValue}"/> contains the specified key.
        /// </summary>
        /// <param name="key">The key to locate in the <see cref="KevastDictionary{TKey, TValue}"/>.</param>
        /// <returns>true if the <see cref="KevastDictionary{TKey, TValue}"/> contains an element with the specified key; otherwise, false.</returns>
        ...
        /// <summary>
        /// Attempts to remove and return the value with the specified key from the <see cref="KevastDictionary{TKey, TValue}"/>.
        /// </summary>
        /// <param name="key">The key of the element to remove and return.</param>
        /// <param name="value">
        /// When this method returns, <paramref name="value"/> contains the object removed from the
        /// <see cref="KevastDictionary{TKey,TValue}"/> or the default value of <typeparamref
        ...
        /// <summary>
        /// Attempts to get the value associated with the specified key from the <see cref="KevastDictionary{TKey,TValue}"/>.
        /// </summary>
        /// <param name="key">The key of the value to get.</param>
        /// <param name="value">
        /// When this method returns, <paramref name="value"/> contains the object from
        /// the <see cref="KevastDictionary{TKey,TValue}"/> with the specified key or the default value of
        /// <typeparamref name="TValue"/>, if the operation failed.
        /// </param>
        /// <returns>true if the key was found in the <see cref="KevastDictionary{TKey,TValue}"/>; otherwise, false.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="key"/> is a null reference (Nothing in Visual Basic).</exception>
        ...
        /// <summary>
        /// Removes all keys and values from the <see cref="KevastDictionary{TKey,TValue}"/>.
        /// </summary>
        public void Clear()
        {
            int locksAcquired = 0;
        ...
        /// <summary>
        /// Copies the key and value pairs stored in the <see cref="KevastDictionary{TKey,TValue}"/> to a
        /// new array.
        /// </summary>
        /// <returns>A new array containing a snapshot of key and value pairs copied from the <see cref="KevastDictionary{TKey,TValue}"/>.
        /// </returns>
        ...
        /// cref="KevastDictionary{TKey,TValue}"/>.</summary>
        /// <returns>An enumerator for the <see cref="KevastDictionary{TKey,TValue}"/>.</returns>
        /// <remarks>
        ...
        private sealed class Enumerator : IEnumerator<KeyValuePair<TKey, TValue>>
        {
            ...
            private readonly KevastDictionary<TKey, TValue> _dictionary;

            private KevastDictionary<TKey, TValue>.Node?[]? _buckets;
            private Node? _node;
            private int _i;
            private int _state;
            ...
            public Enumerator(KevastDictionary<TKey, TValue> dictionary)
            {
            ...
            public bool MoveNext()
            {
                switch (_state)
                {
                    ...
                    case StateOuterloop:
                        KevastDictionary<TKey, TValue>.Node?[]? buckets = _buckets;
        ...
        /// <see cref="KevastDictionary{TKey, TValue}" /> and to provide hash values for the keys.
        /// </value>
        /// <remarks>
        /// <see cref="KevastDictionary{TKey, TValue}" /> requires an equality implementation to determine
        ...
        /// cref="KevastDictionary{TKey,TValue}"/>.
        /// </summary>
        ...
        /// cref="KevastDictionary{TKey,TValue}"/>.</value>
        ...
        /// <summary>
        /// Gets the number of key/value pairs contained in the <see
        /// cref="KevastDictionary{TKey,TValue}"/>. Should only be used after all locks
        /// have been acquired.
        /// </summary>
        /// <exception cref="OverflowException">The dictionary contains too many
        /// elements.</exception>
        ...
        /// <summary>
        /// Adds a key/value pair to the <see cref="KevastDictionary{TKey,TValue}"/>
        ...
        /// <summary>
        /// Adds a key/value pair to the <see cref="KevastDictionary{TKey,TValue}"/> if the key does not already
        /// exist, or updates a key/value pair in the <see cref="KevastDictionary{TKey,TValue}"/> if the key
        /// already exists.
        /// </summary>
        ...
        /// <summary>
        /// Gets a value that indicates whether the <see cref="KevastDictionary{TKey,TValue}"/> is empty.
        /// </summary>
        /// <value>true if the <see cref="KevastDictionary{TKey,TValue}"/> is empty; otherwise,
        /// false.</value>
        public bool IsEmpty
        {
            get
        ...
        /// cref="KevastDictionary{TKey,TValue}"/>.</exception>
        ...
        /// made to the dictionary after <see cref="GetEnumerator"/> was called.
        /// </remarks>
        IEnumerator IEnumerable.GetEnumerator() => ((KevastDictionary<TKey, TValue>)this).GetEnumerator();
        ...
        /// cref="KevastDictionary{TKey,TValue}"/>, this property always
        /// returns false.</value>
        ...
        /// cref="KevastDictionary{TKey,TValue}"/>. -or- A value is being
        ...
        object? IDictionary.this[object key]
        {
            ...
            set
            {
                ...
                ((KevastDictionary<TKey, TValue>)this)[(TKey)key] = (TValue)value!;
            }
        }
    ...
    internal static class ThrowHelper
    {
        ...
        [DoesNotReturn]
        public static void ThrowKeyNullException() => ThrowArgumentNullException("key");

        [DoesNotReturn]
        public static void ThrowOutOfMemoryException() => throw new OutOfMemoryException();

        [DoesNotReturn]
        public static void ThrowValueNullException() => throw new ArgumentException(SR.ConcurrentDictionary_TypeOfValueIncorrect);
    }
}